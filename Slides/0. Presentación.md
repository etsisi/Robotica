...
> <sup>1</sup> Existen recursos muy buenos para ponerte las pilas en muy poco tiempo, como por ejemplo [Codecademy](https://www.codecademy.com/), [Coursera](https://www.coursera.org/specializations/python) o la [clase de Python de Google](https://developers.google.com/edu/python).
  ¡A por ello!
